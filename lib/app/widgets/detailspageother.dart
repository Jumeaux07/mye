...
import 'package:nom_du_projet/app/widgets/message/conversation_screen.dart';
                    ...
                    Positioned(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: CircleAvatar(
                            radius: 50,
                            backgroundImage: NetworkImage(Env.userOther.profileImage ??
                                "https://images.unsplash.com/photo-1732278881253-ed69fb34e01e?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyMnx8fGVufDB8fHx8fA%3D%3D"),
                          ),
                        ),
                      ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      visible: Env.userOther.biographie == null
                          ? false
                          : true,
                      child: Card(
                        elevation: 0.0,
                    ...
                    Visibility(
                      ...
                      visible: controller.userOther.value.experiences?.length == 0
                          ? false
                          : true,
                      child: Card(
                          elevation: 0.0,
                          child: Column(  // Ajout d'un Column pour contenir la liste
                            children: List.generate(
                              ...
                              (index) => ExperienceItem(
                                company: controller.userOther.value.experiences?[index].nomEntreprise ?? "",
                                position: controller.userOther.value.experiences?[index].poste ?? "",
                                period: "${controller.userOther.value.experiences?[index].dateDebut ?? ""} - ${controller.userOther.value.experiences?[index].dateFin ?? ""}", // Correction : dateDebut -> dateFin
                              ),
                            ),
                          ),
                        ),
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: Env.userOther.getCompetence()
                                    .length,
                                shrinkWrap: true,
