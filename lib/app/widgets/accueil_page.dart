          ...
          Visibility(
            ...
            child: CarouselSlider(
              ...
              items: controller.pubList
                  .map((pub) => _buildCarouselItem(pub.titre ?? "",
                      pub.description ?? "", pub.url ?? "", pub.urlimage ?? ""))
                  .toList(),
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Visibility(
                  visible: profileRegisterController.secteursList.isNotEmpty,
                  child: SizedBox(
                    height: 50,
                    child: ListView(
                      shrinkWrap: true,
